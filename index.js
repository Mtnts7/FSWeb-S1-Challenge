...
let ilkFenomen = fenomenler[0]; 
//console.log(ilkFenomen.profile);


//(2) Dizideki üçüncü fenomenin (2. dizin) takipçi (followers) sayısı
let ucuncuFenomen = fenomenler[2];
//console.log(ucuncuFenomen.followers);
...
*/
let justinbieber = fenomenler[6];
justinbieber.profile = "Justin Bieber";
...
//console.log(indekseGoreFenomen(fenomenlerdizi , 3))
...
function fenomenEkle(dizi ,no , profil , follower , post ,platform) {
  let arr = [...dizi];
  const obj = {
    "number": no,
    "profile": profil,
